...
Con el uso de TCP/IP se bre un abanico de nuevas funcionalidades permitiendo
...
\begin{itemize}
\item
  \extranjerismo{Software} para la placa de desarrollo.
\item
  Aplicación web para interacción remota.
\item	
  Documentación del \extranjerismo{software}.
\item	
  Documentación de la aplicación web.
\item
  Repositorio en línea con el código del \extranjerismo{software}.
\item
