...
\usepackage[
  ...
  autolang=other,    % Controla que lenguaje es usado por el entorno.
  sortlocale=es_ES,  % Ordena la bibliografía usado el lenguaje indicado.
...
\noindent D. tutor, profesor del Departamento de Ingeniería Electromecánica, Área de Ingeniería de Sistemas y Automática.

\noindent Expone:

\noindent Que el alumno D. \nombre, con DNI 12345678Z, ha realizado el Trabajo final de Máster Universitario en Ingeniería Informática titulado Comunicación TCP/IP con sistemas empotrados. 
...
\begin{abstract}
  ...
  An embedded systems connected to a data network obtains a new way of 
  interaction with other systems, whether embedded or conventional. A connected
  embedded system allows to interact remotely with it, being able to carry out, 
